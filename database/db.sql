## I hade to create a postgres server container with docker access the cli terminal and create a new user and database then copy and past the below code to create the tables and insert the data.
